      ...
      >
        ...
        <div className="hero-content text-center w-full sm:w-3/4 md:w-2/3 lg:w-2/3 font-mono px-4">
          <div className="w-full sm:w-3/4 md:w-1/2 p-6 md:p-10 bg-base-200 rounded-lg">
            <h1 className="mb-4 text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">
              Tru
            ...
            <button
              onClick={login}
              disabled={isLoading}
              className={`w-full btn btn-info font-bold text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50 ${
